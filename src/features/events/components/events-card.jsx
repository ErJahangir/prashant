        ...
        <div className="space-y-3 text-gray-600">
          ...
          {eventData.startTime && eventData.endTime ? (
            <div className="flex items-center space-x-3">
              ...
              <span>{eventData.startTime.substring(0, 5)} – {eventData.endTime.substring(0, 5)}</span>
            </div>
          ) : null}
          {eventData.location ? (
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-500">
                {eventData.startTime && eventData.endTime ? "Venue to be announced" : "Time & venue to be announced"}
              </span>
            </div>
          )}
        </div>
