            ...
            {!isLoading && !error && (!wishes || wishes.length === 0) && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  No messages yet. Be the first to send your blessings!
                </p>
              </div>
            )}
              ...
              <div className="backdrop-blur-sm bg-white/80 p-8 rounded-2xl border border-emerald-100 shadow-lg text-center">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Your message and blessings have been sent. We truly
                    appreciate your wishes.
                  </p>
                  <p className="text-sm text-gray-500 italic">
                    Each guest can send one message only.
                  </p>
                </div>
              </div>
            ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        id="wish-message"
                        name="message"
                        placeholder="Send your blessings and wishes for the couple..."
                        value={newWish}
